...
options {tokenVocab=SQLStatementLexer;}
...
ddlStatement
    ...
    | createLogfileGroup | alterLogfileGroup | dropLogfileGroup
    | createProcedure | alterProcedure | dropProcedure
    | createServer | alterServer | dropServer
    | createTable | alterTable | dropTable
    | createTablespace | alterTablespace | dropTablespace
...
createDatabase
    : CREATE dbFormat=(DATABASE | SCHEMA)
      ifNotExists? uid createDatabaseOption* SEMI?
    ;
