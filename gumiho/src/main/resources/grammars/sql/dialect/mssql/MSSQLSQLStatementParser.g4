...
/**
* SQL-2003: https://ronsavage.github.io/SQL/sql-2003-2.bnf.html
*/
parser grammar MSSQLSQLStatementParser;

options {tokenVocab=MSSQLSQLStatementLexer;}
...
constant_expression
    : NULL
    | constant
    // system function: https://msdn.microsoft.com/en-us/library/ms187786.aspx
    | function_call
...
// https://docs.microsoft.com/en-us/sql/t-sql/function/openxml-transact-sql
open_xml
...
function_call
    ...
    // https://docs.microsoft.com/en-us/sql/t-sql/function/getdate-transact-sql
    | GETDATE '(' ')'                                   #GETDATE
    // https://docs.microsoft.com/en-us/sql/t-sql/function/getdate-transact-sql
...
// https://docs.microsoft.com/en-us/sql/t-sql/function/analytic-function-transact-sql
