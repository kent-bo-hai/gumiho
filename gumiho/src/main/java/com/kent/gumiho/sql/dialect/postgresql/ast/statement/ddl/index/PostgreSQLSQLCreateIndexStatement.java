 ...
 */
public class PostgreSQLSQLCreateIndexStatement extends AbstractPostgreSQLSQLStatement implements PostgreSQLSQLCreateStatement {


    public PostgreSQLSQLCreateIndexStatement(DBType dbType) {
        super(dbType);
    }
