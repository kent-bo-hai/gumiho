 ...
 */
public class MSSQLSQLDropFunctionStatement extends AbstractMSSQLSQLStatement implements MSSQLSQLDropStatement {

    public MSSQLSQLDropFunctionStatement(DBType dbType) {
        super(dbType);
    }
}
