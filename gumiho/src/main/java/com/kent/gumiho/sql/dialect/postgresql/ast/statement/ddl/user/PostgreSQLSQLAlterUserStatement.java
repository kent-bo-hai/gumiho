 ...
 */
public class PostgreSQLSQLAlterUserStatement extends AbstractPostgreSQLSQLStatement implements PostgreSQLSQLAlterStatement {

    public PostgreSQLSQLAlterUserStatement(DBType dbType) {
        super(dbType);
    }
