package com.kent.gumiho.sql.dialect.mysql.ast.statement.ddl.event;
 ...
 */
public class MySQLSQLCreateEventStatement extends AbstractMySQLSQLStatement implements MySQLSQLCreateStatement {


    public MySQLSQLCreateEventStatement() {
