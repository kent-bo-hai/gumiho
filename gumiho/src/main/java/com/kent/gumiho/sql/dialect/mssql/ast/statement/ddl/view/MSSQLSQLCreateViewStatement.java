 ...
 */
public class MSSQLSQLCreateViewStatement extends AbstractMSSQLSQLStatement implements MSSQLSQLCreateStatement {


    public MSSQLSQLCreateViewStatement(DBType dbType) {
        super(dbType);
    }
