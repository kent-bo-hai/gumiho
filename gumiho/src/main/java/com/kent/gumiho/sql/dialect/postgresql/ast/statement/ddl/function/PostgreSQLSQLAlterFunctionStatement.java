 ...
 */
public class PostgreSQLSQLAlterFunctionStatement extends AbstractPostgreSQLSQLStatement implements PostgreSQLSQLAlterStatement {

    public PostgreSQLSQLAlterFunctionStatement(DBType dbType) {
        super(dbType);
    }
