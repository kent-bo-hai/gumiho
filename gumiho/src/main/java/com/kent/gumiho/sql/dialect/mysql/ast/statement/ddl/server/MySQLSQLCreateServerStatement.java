package com.kent.gumiho.sql.dialect.mysql.ast.statement.ddl.server;
 ...
 */
public class MySQLSQLCreateServerStatement extends AbstractMySQLSQLStatement implements MySQLSQLCreateStatement {


    public MySQLSQLCreateServerStatement() {
    }
