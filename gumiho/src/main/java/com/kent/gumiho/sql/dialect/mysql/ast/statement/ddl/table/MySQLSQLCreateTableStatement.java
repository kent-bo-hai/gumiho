package com.kent.gumiho.sql.dialect.mysql.ast.statement.ddl.table;
 ...
 */
public class MySQLSQLCreateTableStatement extends AbstractMySQLSQLStatement implements MySQLSQLCreateStatement {

    public MySQLSQLCreateTableStatement() {
    }
