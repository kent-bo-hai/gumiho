 ...
 */
public class PostgreSQLSQLDropTriggerStatement extends AbstractPostgreSQLSQLStatement implements PostgreSQLSQLDropStatement {

    public PostgreSQLSQLDropTriggerStatement(DBType dbType) {
        super(dbType);
    }
