 ...
 */
public class PostgreSQLSQLCreateServerStatement  extends AbstractPostgreSQLSQLStatement implements PostgreSQLSQLCreateStatement {


    public PostgreSQLSQLCreateServerStatement(DBType dbType) {
        super(dbType);
    }
