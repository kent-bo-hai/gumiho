 ...
 */
public class PostgreSQLSQLAlterLogfileGroupStatement extends AbstractPostgreSQLSQLStatement implements PostgreSQLSQLAlterStatement {

    public PostgreSQLSQLAlterLogfileGroupStatement(DBType dbType) {
        super(dbType);
    }
