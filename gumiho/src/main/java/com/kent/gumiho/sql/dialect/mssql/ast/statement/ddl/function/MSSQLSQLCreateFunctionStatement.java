 ...
 */
public class MSSQLSQLCreateFunctionStatement extends AbstractMSSQLSQLStatement implements MSSQLSQLCreateStatement {


    public MSSQLSQLCreateFunctionStatement(DBType dbType) {
        super(dbType);
    }
