 ...
 */
public class PostgreSQLSQLCreateEventStatement extends AbstractPostgreSQLSQLStatement implements PostgreSQLSQLCreateStatement {


    public PostgreSQLSQLCreateEventStatement(DBType dbType) {
        super(dbType);
    }
