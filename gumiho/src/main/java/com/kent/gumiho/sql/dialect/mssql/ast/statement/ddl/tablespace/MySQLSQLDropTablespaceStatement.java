 ...
 */
public class MySQLSQLDropTablespaceStatement extends AbstractMySQLSQLStatement implements SQLDDLStatement {

    public MySQLSQLDropTablespaceStatement(DBType dbType) {
        super(dbType);
    }
}
