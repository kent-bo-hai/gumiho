 ...
 */
public class MSSQLSQLCreateEventStatement extends AbstractMSSQLSQLStatement implements MSSQLSQLCreateStatement {


    public MSSQLSQLCreateEventStatement(DBType dbType) {
        super(dbType);
    }
