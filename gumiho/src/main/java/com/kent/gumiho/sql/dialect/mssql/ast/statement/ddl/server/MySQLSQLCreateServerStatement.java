 ...
 */
public class MySQLSQLCreateServerStatement extends AbstractMySQLSQLStatement implements SQLDDLStatement {


    public MySQLSQLCreateServerStatement(DBType dbType) {
        super(dbType);
    }
