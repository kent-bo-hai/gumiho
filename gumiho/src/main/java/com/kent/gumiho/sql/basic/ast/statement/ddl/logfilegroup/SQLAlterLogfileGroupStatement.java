 ...
 */
public class SQLAlterLogfileGroupStatement extends AbstractSQLStatement implements SQLAlterStatement {

    public SQLAlterLogfileGroupStatement(DBType dbType) {
        super(dbType);
    }
