 ...
 */
public class PostgreSQLSQLDropFunctionStatement extends AbstractPostgreSQLSQLStatement implements PostgreSQLSQLDropStatement {

    public PostgreSQLSQLDropFunctionStatement(DBType dbType) {
        super(dbType);
    }
