 ...
 */
public class MSSQLSQLCreateIndexStatement extends AbstractMSSQLSQLStatement implements MSSQLSQLCreateStatement {


    public MSSQLSQLCreateIndexStatement(DBType dbType) {
        super(dbType);
    }
