 ...
 */
public class PostgreSQLSQLAlterDatabaseStatement extends AbstractPostgreSQLSQLStatement implements PostgreSQLSQLAlterStatement {

    public PostgreSQLSQLAlterDatabaseStatement(DBType dbType) {
        super(dbType);
    }
