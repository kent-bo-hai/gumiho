 ...
 */
public class MSSQLSQLAlterProcedureStatement extends AbstractMSSQLSQLStatement implements MSSQLSQLAlterStatement {

    public MSSQLSQLAlterProcedureStatement(DBType dbType) {
        super(dbType);
    }
}
