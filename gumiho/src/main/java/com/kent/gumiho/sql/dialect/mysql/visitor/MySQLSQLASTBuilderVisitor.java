...
import com.kent.gumiho.sql.dialect.mysql.parser.MySQLSQLStatementParserBaseVisitor;
 ...
 */
public class MySQLSQLASTBuilderVisitor extends AbstractParseTreeVisitor<Boolean> implements MySQLSQLStatementParserVisitor<Boolean> {


    private final List<SQLStatement> statements;

    public MySQLSQLASTBuilderVisitor(List<SQLStatement> statements) {
