 ...
 */
public class PostgreSQLSQLDropTableStatement extends AbstractPostgreSQLSQLStatement implements PostgreSQLSQLDropStatement {

    public PostgreSQLSQLDropTableStatement(DBType dbType) {
        super(dbType);
    }
