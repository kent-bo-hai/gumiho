 ...
 */
public class PostgreSQLSQLDropUserStatement extends AbstractPostgreSQLSQLStatement implements PostgreSQLSQLDropStatement {

    public PostgreSQLSQLDropUserStatement(DBType dbType) {
        super(dbType);
    }
